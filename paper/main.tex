...
TODO: maybe mention \url{https://satcompetition.github.io/2020/}

TODO: Maybe mention proceedings \cite{SC2020}
...
An unsatisfiable formula was considered solved if {\tt cake\_lpr} could validate
the corresponding LRAT proof.
Otherwise the formula was considered unsolved by the solver in question.

TODO: Markus, did we really wait for cake to confirm, otherwise not calling it solved?
...
This could result in some solvers not ``daring'' to use the full \SI{128}{\giga\byte}
in the competition.}
...
In the following we provide a summary of the new strategies implemented in the award winning solvers in this competition. 


\subsection{Sequential SAT Solving: Winners of the Main and Incremental Tracks}

In the main track, a total of $18$ teams submitted their solvers to the competition.  
Table~\ref{tab:solvers-main} displays an overview of the participating teams, base solvers and their variants. 
$11$ teams submitted variants of a previously existing base solver such as Maple~\cite{} or Cadical~\cite{}. 
...
The 32-core variant won third prices in the overall evaluation and in the unsat sub-track. 
