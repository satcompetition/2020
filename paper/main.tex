...
showis up in the greedy set cover. 
...
Contributions to the VBS can becaptured by clustering the instance space into instance families. 
...
Interestingly, one identifiable large cluster consists of the \solver{Maple}-decedants, 
...
While essentially none of the solvers that participated in the Planning track seemd particularly optimized for Planning instance, we hope
