...
To participate in the Main track, solvers needed to output certificates for both the satisfiable and the unsatisfiable instances. Moreover, the source code of the solver were required 
...
The No-Limits track was only evaluated with respect  \emph{newly} submitted benchmark instances, i.e., on instances
which were submitted to SAT Competition 2020.
...
of small modifications of the Glucose 3.0 SAT solver.\textcolor{red}{Add reference} The limit for participating in the Hack track
was---somewhat arbitrarily\footnote{The specific threshold for edit distance is not central here; the idea is essentially to only allow relatively small changes to the Glucose
code base, i.e., ``quick hacks'' to Glucose.}---set to 1000 non-space character edit distance from the sources of Glucose provided by the organizers. 
