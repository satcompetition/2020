...
was arbitrarily set to 1000 non-space character edit distance from the sources of Glucose provided by the organizers. 
...
New this year was the Cloud track, dedicated to evaluating distributed solvers. Similar to the
...
Four solvers participating in the Main track (\solver{Kissat-sat}, \solver{Relaxed-newTech}, \solver{CaDiCaL-alluip-trial}, and \solver{CMS-ccnr-lsids}) 
...
The solver performance on unsatisfiable formulas was much closer,
...
quite close as well. The third ranked solver, \solver{Kissat}, solved fewer instances, but its fast runtime
on several instances resulted in a strong PAR-2 score. Notice that these solvers were also strong in the Main track. 
...
\solver{Mallob-Mono} was able to solver more instances in 1000 seconds than the 
...
in developing a distributed solver. 2020 was the first year of this track. We expect that the gap will be 
smaller in the future years. 
...
Starting as a fork of \solver{Minisat} with the integration of special xor treatment~\cite{Soos:2009:Crypto},
...
All the winning solvers of the \emph{Main} track periodically schedule runs of an SLS solver and import statistical information generated in unsuccessful SLS runs to reconfigure weights in their branching heuristics. 
