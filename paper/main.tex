...
In order to create a balanced set of 300 new benchmarks and 100 old benchmarks, i.e., instances seen in previous competitions, we executed the following steps of \emph{rule-based randomization}. 
...
With additional constraints, we made sure not to select instances of families which are already represented in the set of 300 new instances. 
