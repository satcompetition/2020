...
\phantom{0} & \phantom{0} & \phantom{0} & \phantom{0}
\end{tabularx}
\caption{Results of Main, Planning, Parallel and Cloud Tracks: Place~(Pl.), Score (PAR-2) and Number of Solved Instances~(\#) per Solver}
\label{tab:cloud}
\end{table}
...
Each table shows the first ten solvers sorted according to the respective metric.\todo{Maybe move classic PAR-2 ranking also to here for comparison}}
