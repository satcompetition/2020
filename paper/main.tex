...
\hline
\end{tabular}
\caption[Teams and Solvers in the Main Tracks]{Teams and Solvers in the Main Tracks: In favour of highlighting the relevant branch in the Maple tree of solvers, we identify configuration names of solvers, as well as variants of other base solvers in Column~3 ``Variant / Name''. To avoid confusion, we \solver{underlined} the names of the submitted solvers.}
