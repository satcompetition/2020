...
In a few cases {\tt DRAT-trim} ran into the verification timeout of 40,000 seconds. 
...
In the Main track, proof validation was limited to 40,000 seconds per proof.)
...
To compile the set of 300 new instances, we first applied a hardness criterion by filtering out all instances solved by \solver{Minisat} in less than ten minutes.\footnote{We note that
...
\solver{CaDiCaL-alluip} is the best in further contributing to the set by additional $22$ instances in iteration $2$.
