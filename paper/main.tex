...
These four top solvers all have a different code base, which is rare. In recent competitions, top solvers were much closer together.
...
Since the SAT Competition started to rank based on PAR-2 score, such cases have been observed several times. 
...
that the VBS is reasonably close to \solver{Kissat-unsat}. \solver{Kissat} is a new solver,
which has been implemented in C, while most solvers are implemented in C++. Further 
