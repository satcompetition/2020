...
The traditional Hack track (est. 2009 as \solver{Minisat} Hack track) was organized as a sub-track of the Main track for hacks of \solver{Glucose 3}. 
...
The limit for being considered a ``hack'' was---somewhat arbitrarily---set to 1000 non-space character edit distance from the sources of \solver{Glucose 3}. 
