...
\multirow{2}{*}{Zhang, Cai}
    & \multirow{2}{*}{\solbert{MapleLCMDistCBT-DL}} & \solver{Relaxed} & \\
...
(Amusingly, as can be seen from the ``contributes'' column, the presence of MapleLCMDistChronoBT-DL-f2trc
is not necessary. However, allowing any other solver to run for the 76 ``wasted'' seconds would not increase the overall total.)
