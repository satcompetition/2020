...
BYOB, see also Sect.~\ref{sec:byob}

Also these have description

\cite{SC2020}

% input/output and proof formats
SAT solvers must conform to DIMACS input/output requirements


SAT solvers that are planning to participate in the Main track must be able to produce certificates for UNSAT


Each Main Track participant (team) is required to submit 20 new benchmark instances. 


Participation of Portfolios / Number of submissions
...
The organizers of SAT Competition 2020 are not allowed to compete.
