...
\caption{Number of benchmarks generated per encoding.}
\end{table}
...
Contributions to the VBS can be well capatured by clustering the instance space by instance families. 
We evaluated the runtimes of the three winning solvers of the Main track on the most represented instance families (see Table~\ref{tab:families}) and report on their place and score in Table~\ref{tab:eval-by-family}. 
