...
unit clause assumptions \cite{TODO}. 
...
Numerous applications, e.g., SMT solvers or SAT-based planners,
use SAT solvers incrementally, i.e., formulas are repeatedly refined between the solver calls.
In SAT~Competitions 2020, we selected a total \num{300} benchmark instances for the Incremental track
from the six applications described below.
