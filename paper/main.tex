...
The PAR-2 score of the VBS of all $48$ submitted solvers in the Main track is $2431.4$, which is much better than the PAR-2 score of $3926.2$ of the single best solver \solver{Kissat-sat}. 
...
With the only exception being $\solver{Scavel01} \in T_6 \cap T_7$, all solvers in $T_1, \dots, T_7$ belong the top performing solvers in the Main track (cf. Table~\ref{tab:results}). 
