...
We evaluated all 64 submitted solver configurations of which eight have been explicitly submitted to the No-Limits track, and four configurations were demoted to the No-Limits track due to wrong certificates. 
A total of six configurations got disqualified due to wrong answers. 
This left us with 46 configurations of 22 solvers inluding one Glucose hack. 
...
In this competition, two of the six submissions got disqualified, such that we had only four solvers competing in the Incremental track. 
...
In the Parallel track, we evaluated ten solvers (in 14 configurations) out of which three solvers got disqualified due to wrong answers. 
...
We evaluated six solvers in this track. 
