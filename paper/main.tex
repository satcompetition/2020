...
\bf Place & \bf PAR-2 Score & \bf Num. Solved & \bf Solver \\
\hline
 1    & 2997.4 & 150 & \solbert{Relaxed\_newTech} \\
...
\stack{Soos, Cai, Devriendt, Gocht, }{Shaw, Meel}~ & \solver{CryptoMiniSat 5} & 3 \\
\hline
...
\centering
\begin{tabular}{ccl}
\bf VBS1 & \bf Percent Total & \bf Solver \\
\hline
...
13 & \phantom{0}3.2 & \solver{Maple-alluip-trail} \\
...
~\\[1em]
\begin{tabular}{ccl}
\bf VBS2 & \bf Percent Total & \bf Solver \\
\hline
...
\phantom{0}84.1 & 21.0 & \solver{CaDiCaL-alluip-trail} \\
...
\centering
\begin{tabular}{clccc}
\bf Iteration & \bf Selected Solver & \bf Num. Solved & \bf Contributes \\ % & covered so far \\
\hline
...
\centering
\begin{tabular}{cccl}
\bf \#Solvers & \bf Time (s) & \bf Num. Solved & \bf Best Schedule \\
\hline
1 & 5000 & 264 & \solver{\{Kissat-sat\}} \\
2 & 2500 & 278 & \solver{\{Kissat-unsat, Relaxed\_newTech\}} \\
3 & 1666 & 272 & \solver{\{Kissat-unsat, Kissat-sat, }\\
			 &&& \solver{CMS-ccnr-lsids\}} \\
4 & 1250 & 262 & \solver{\{Kissat-unsat, Kissat-sat, }\\
			 &&& \solver{CMS-ccnr-lsids, Maple-alluip-trail\}} \\ 
5 & 1000 & 253 & \solver{\{Kissat-unsat, Kissat-sat, }\\
			&&& \solver{CMS-ccnr-lsids, Maple-alluip-trail, }\\ 
			&&& \solver{CaDiCaL-alluip \}}\\
\end{tabular}
...
\centering
\begin{tabular}{lccc}
\bf Solver & \bf Taking Up (s) & \bf Solving Under Limit & \bf Contributes \\
\hline
...
%\solver{Kissat-unsat} & \solver{CryptoMiniSat-Walksat} & \solver{f2trc-DL} & $2877.8$\\
%\solver{CaDiCaL-alluip} & \solver{CryptoMiniSat-Walksat} & \solver{DurianSat} & $2877.8$\\
%\solver{CaDiCaL-alluip} & \solver{CryptoMiniSat-Walksat} & \solver{f2trc-DL} & $2877.8$\\
%\solver{CaDiCaL-alluip} & \solver{CryptoMiniSat-CCAnr} & \solver{Kissat} & $2877.8$\\
\end{tabular}
...
% & \solver{CMS-CCAnr lsids} & \solver{Scavel01} & \solver{f2trc-DL} & 2752.6
\end{tabular}
